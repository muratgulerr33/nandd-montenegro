  ...
  return (
    <Sheet open={open} onOpenChange={setOpen}>
      ...
      >
        ...
        <div className="flex items-center justify-between h-14 px-4 border-b border-border shrink-0 pt-[env(safe-area-inset-top)]">
          <SheetTitle asChild>
        ...
        <div className="flex-1 overflow-y-auto overscroll-contain px-4 py-4">
          <nav className="flex flex-col gap-1">
            <Link
              ...
              className="t-nav block py-3 rounded-lg hover:bg-accent hover:text-accent-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 transition-colors"
            >
              {t('home')}
            </Link>
            <Link 
